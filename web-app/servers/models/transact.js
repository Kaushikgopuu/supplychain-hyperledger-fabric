...
exports.sendToWholesaler = async information => {
    ...
    if (dev) {
        return productModel.updateStatusDev(productId, { Status: 'AtWholesaler', WholesalerID: userId });
    }
...
exports.sendToDistributer = async information => {
    const { productId , userId , id } = information;
    if (dev) {
        return productModel.updateStatusDev(productId, { Status: 'AtDistributor', DistributorID: userId });
    }
...
exports.sendToRetailer = async information => {
    const { productId , userId , id } = information;
    if (dev) {
        return productModel.updateStatusDev(productId, { Status: 'AtRetailer', RetailerID: userId });
    }
    const networkObj = await network.connect(false, true, false, id);
...
exports.sellToConsumer = async information => {
    ...
    if (dev) {
        return productModel.updateStatusDev(productId, { Status: 'Sold' });
    }
    const networkObj = await network.connect(false, true, false, id);
