...
export class SignIn extends Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post("/user/signin/" + this.state.role, signIn, {
        headers: {
      ...
      .catch((err) => {
        ...
        const msg = (backend && backend.message) || backend || "Sign-in failed. Check backend and credentials.";
        alert(msg);
      });
  }
